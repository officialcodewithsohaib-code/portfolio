  ...
  const skillCategories = [
    {
      ...
      skills: [
        ...
        { name: "TypeScript", icon: <FaCode />, level: 50 },
      ],
    ...
    },
    {
      ...
      skills: [
        { name: "OpenAI (Learning)", icon: <SiOpenai />, level: 10 },
        { name: "LangChain (Learning)", icon: <FaBrain />, level: 10 },
        { name: "Docker (Learning)", icon: <SiDocker />, level: 10 },
      ],
